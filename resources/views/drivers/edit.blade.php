...
<body class="bg-blue-50 p-8">
   <div class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-blue-100">
        ...
        <form action="{{ route('drivers.update', $driver->id) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')
           <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 opacity-70">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $driver->plate_nomor }}" readonly 
                           class="w-full bg-blue-50 border border-blue-200 p-2.5 rounded-lg cursor-not-allowed text-gray-600 uppercase">
                </div>
            </div>
